...
1. 네트워크 계층화의 필요성
    - 복잡한 네트워크 통신을 단순화하고 표준화하기 위한 접근
    - 각 계층별 독립적인 발전과 유지보수 가능
    - 다양한 벤더/기기 간 호환성 보장

2. 학습 목표
    - OSI 7계층과 TCP/IP 4계층의 개념과 차이점 이해
    - 데이터가 각 계층을 거쳐 전송되는 과정 파악
    - 실무에서 자주 사용되는 프로토콜들의 계층별 분류 학습
...
1. 탄생 배경
    ...
    - 당시 네트워크 기술이 벤더별로 파편화되어 있던 문제 해결 필요
    - 개방형 시스템 간의 통신을 위한 표준 프레임워크 제시

2. 설계 철학
    - 계층별 독립성: 각 계층은 독립적으로 발전/수정 가능
    - 유연성: 하위 계층의 변경 없이 상위 계층 수정 가능
    - 표준화: 제조사나 기술에 관계없이 동일한 통신 규격 제공
